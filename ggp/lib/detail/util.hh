...
#define GGP_LIB_DETAIL_STRUCT_FIELDS_EX_3(tuple_of_pairs) PP_APPLY(GGP_LIB_DETAIL_STRUCT_FIELDS_FUNC, tuple_of_pairs)
#define GGP_LIB_DETAIL_STRUCT_FIELDS_EX_2(tuple_of_pairs) GGP_LIB_DETAIL_STRUCT_FIELDS_EX_3(tuple_of_pairs)
#define GGP_LIB_DETAIL_STRUCT_FIELDS_EX_1(...) GGP_LIB_DETAIL_STRUCT_FIELDS_EX_2(PP_TUPLE_OF_N_TUPLES(2, __VA_ARGS__))
#define GGP_LIB_DETAIL_STRUCT_FIELDS(...) GGP_LIB_DETAIL_STRUCT_FIELDS_EX_1(__VA_ARGS__)
